...
const Details: React.FC<DetailsProps> = ({children}) => {
    return(
        <div className="container overflow-auto">
            ...
            <p className="text-base font-sans text-left text-primary pb-4">Currently, my focus is on building required components, coming up with innovative solutions at <a className="text-accent-light font-medium hover:text-tertiary transition duration-500" href="https://quicksite.guru/" target='_blank' rel='noopener noreferrer'>Trackday</a> as an intern to create frontend modules for motosport clubs in a single platform developed with WordPress and BuddyBoss, that also includes membership management, social space management and event managment.</p>
