    ...
    return (
        <div className="container">
            ...
            <div className='flex fixed flex-col lg:bottom-32 lg:top-auto lg:right-auto top-10 right-16'>
                <div className='group'>
                    <a className='flex cursor-pointer text-secondary transition-all duration-300 font-normal group-hover:text-accent-tertiary_light' href='https://storage.googleapis.com/portfolio-v2-static-data/Resume-v2.docx'>
